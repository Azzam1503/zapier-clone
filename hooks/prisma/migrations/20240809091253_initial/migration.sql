...
-- AddForeignKey
ALTER TABLE "Trigger" ADD CONSTRAINT "Trigger_trigerrId_fkey" FOREIGN KEY ("trigerrId") REFERENCES "AvailableTriggers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
